...
class AppColors {
  ...
  // `context.colors.X` (AppSemanticColors, lib/core/theme/) en su lugar.
  // Estas constantes quedan únicamente para los pocos lugares sin context
  // (ej. definiciones de enum) donde no hay forma de acceder al tema.
