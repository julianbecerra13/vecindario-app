...
final externalServicesRepositoryProvider =
    Provider<ExternalServicesRepository>((ref) {
  return ExternalServicesRepository(ref.watch(firestoreProvider));
});

final externalCategoryProvider =
    StateProvider<ExternalCategory?>((ref) => null);

final externalServicesListProvider =
    StreamProvider<List<ExternalServiceModel>>((ref) {
