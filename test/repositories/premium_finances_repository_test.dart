...
void main() {
  ...
  group('PremiumRepository - Finanzas', () {
    ...
    test(
      'watchBudgets devuelve un mapa vacío cuando no hay presupuestos',
      () async {
    ...
    test(
      'watchAccountStatements permite separar morosos de quienes están al día',
      () async {
        const communityId = 'comm-1';
        await firestore
        ...
        final statements = await repository
